...
; ****************************************************************************************************
  ...
  FOR V=0, N_ELEMENTS(VERSION)-1 DO BEGIN
    ...
    IF KEYWORD_SET(ANIMATIONS) THEN $
      PROJECT_COMPOSITE_ANIMATION, VERSTR, /WEEKS, EXTENSIONS=['webm','mp4'],BUFFER=BUFFER, FRAMES=2, /ADD_COLORBAR, /ADD_BATHY, /ADD_LONLAT, LONS=[-73,-70,-67],LATS=[40,42,44],/ADD_BOARDER;, OUTCOLOR=0
